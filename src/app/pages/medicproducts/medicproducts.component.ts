...
@Component({
  selector: "app-medicproducts",
  templateUrl: "./medicproducts.component.html",
  styleUrls: ["./medicproducts.component.css"]
})
export class MedicproductsComponent implements OnInit {
